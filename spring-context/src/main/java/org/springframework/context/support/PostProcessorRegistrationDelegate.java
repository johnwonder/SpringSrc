...
final class PostProcessorRegistrationDelegate {
	...
	public static void invokeBeanFactoryPostProcessors(
		...
		if (beanFactory instanceof BeanDefinitionRegistry) {
			...
			//@1 如果已经有beanFactoryPostProcessors
		...
		//todo PropertyPlaceholderConfigurer类实现了 BeanFactoryPostProcessor 所以会在此处处理 2020-09-12
		// Do not initialize FactoryBeans here: We need to leave all regular beans
		// uninitialized to let the bean factory post-processors apply to them!
		String[] postProcessorNames =
		...
		for (String ppName : postProcessorNames) {
			if (processedBeans.contains(ppName)) {
				...
				//todo PropertyPlaceholderConfigurer类实现了 PriorityOrdered 2020-09-12
		...
		for (String postProcessorName : orderedPostProcessorNames) {
			//todo 会获取PostProcessor这个bean放入orderedPostProcessors 集合里 2020-09-28
			//todo CustomEditorConfigurer 实现了Ordered接口 2020-09-28
	...
	public static void registerBeanPostProcessors(
		...
		List<String> nonOrderedPostProcessorNames = new ArrayList<>();
		for (String ppName : postProcessorNames) {
			//会先找实现 PriorityOrdered 接口的 BeanPostProcessor
			if (beanFactory.isTypeMatch(ppName, PriorityOrdered.class)) {
